...
//        binding.welcomeText.text = viewModel.getFactToDisplay(requireContext())
        ...
        binding.safeZoneButton.text = getString(R.string.safe_zone_button)
        ...
        viewModel.authenticationState.observe(viewLifecycleOwner, Observer { authenticationState ->
            ...
            when (authenticationState) {
                LoginViewModel.AuthenticationState.AUTHENTICATED -> {
                    ...
                    binding.safeZoneButton.isEnabled = true
                    binding.safeZoneButton.isVisible = true
                    ...
                    binding.safeZoneButton.isEnabled = false
                    binding.safeZoneButton.isVisible = false
                    binding.authButton.setOnClickListener {
                        launchSignInFlow()
                    }
                }
